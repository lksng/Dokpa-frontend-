...
export const activities: Activity[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Discover the ancient art of traditional paper making in this hands-on workshop. Learn from master craftsmen who have preserved centuries-old techniques, using natural fibers and traditional tools. You'll participate in the entire process from preparing raw materials to creating your own handmade paper sheets to take home as unique souvenirs.",
    duration: "4 hours",
    difficulty: "Easy",
  ...
  },
  {
    ...
    fullDescription:
      "Experience the ultimate adventure with the famous Mago Trek, featuring a spectacular hot air balloon ride at sunrise. This unique combination of trekking and aerial viewing offers unparalleled perspectives of the landscape. The trek leads to the launch site, followed by a magical balloon flight over valleys, rivers, and mountain ranges.",
    duration: "10 hours",
    difficulty: "Moderate",
